...
ggplot(aes( x = `Tire Brand`, y = tread, color = `Tire Brand`)) +
  geom_boxplot(alpha = 0) + #needed to avoid double-plotting points outside fence
  geom_point(alpha = 0.5) +
  geom_line(aes(group = car), color = "grey", alpha = 0.8) +
...
```{r observedPlotPaired, echo = TRUE, fig.height = 12}
