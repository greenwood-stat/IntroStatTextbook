...
```{r install-vs-library, fig.cap = "Installing (`install.packages()`) versus loading (`library()`) R packages.", out.width="100%"}
include_graphics("00/images/RInstallvsLibrary.jpeg")
```
...
```{r installCatstats, echo=TRUE, eval=FALSE}
