...
```{r include=FALSE}
terms_chp_14 <- c("statistic", "point estimate", "parameter", "test statistic")
```
...
```{r include=FALSE}
terms_chp_14 <- c(terms_chp_14, "null value")
```
...
```{r include=FALSE}
terms_chp_14 <- c(terms_chp_14, "success-failure condition", "independence condition", "standard error of the sample proportion")
```
...
```{r include=FALSE}
terms_chp_14 <- c(terms_chp_14, "confidence level")
```
